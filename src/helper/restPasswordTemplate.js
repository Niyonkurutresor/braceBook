...
<head>
  ...
  <style>
    ...
    .container {
      ...
      background-image: url('https://res.cloudinary.com/kist/image/upload/v1688674327/sp1c1pmptwrktvkvmd3i.png');
    }
    .header {
      text-align: center;
      margin-bottom: 30px;
...
<body>
  <div class="container">
    ...
    <div class="button-container">
      <a class="button" href="${data.passwordResetURL}" target="_blank">Confirm Email</a>
    </div>
